...
Sistema de visão computacional desenvolvido em **Python 3.13.13** utilizando **YOLO11s (Ultralytics)** para detecção e classificação automática de materiais em tempo real.
